...
export const dict: Dict = {
  ...
  "spartan.tier1Feature3": { sl: "Standardne frakcije (Klasična postavitev MODRI vs. RDEČI)", en: "Standard Factions (Classic BLUE vs RED team setup)" },
  "spartan.tier1Feature4": { sl: "Cena: 0 € / Brezplačno za vedno", en: "Cost: €0 / Free Forever" },

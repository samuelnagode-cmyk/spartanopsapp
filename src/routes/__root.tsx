...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "SpartanOps: tactical webpage app for real-time airsoft match tracking." },
      { name: "author", content: "SpartanOps" },
      { property: "og:title", content: "SpartanOps APP" },
      { property: "og:description", content: "SpartanOps: tactical webpage app for real-time airsoft match tracking." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "SpartanOps APP" },
      { name: "twitter:description", content: "SpartanOps: tactical webpage app for real-time airsoft match tracking." },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6ec0937e-6a58-49ab-98d2-0c82e132cad7/id-preview-37ba9664--33de6eca-68c2-4a42-9f00-d319caae0b82.lovable.app-1783850556257.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6ec0937e-6a58-49ab-98d2-0c82e132cad7/id-preview-37ba9664--33de6eca-68c2-4a42-9f00-d319caae0b82.lovable.app-1783850556257.png" },
    ],
    links: [

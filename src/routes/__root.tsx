...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SpartanOps" },
      ...
      { name: "twitter:title", content: "SpartanOps" },
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/pnuEeej0s2fuaeyJ1j4H7JsWP8j1/social-images/social-1784618784760-social_m,edia_(lovable)_red_logo-27.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/pnuEeej0s2fuaeyJ1j4H7JsWP8j1/social-images/social-1784618784760-social_m,edia_(lovable)_red_logo-27.webp" },
    ],
    links: [
